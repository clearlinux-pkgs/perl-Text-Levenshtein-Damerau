...
cp %{_builddir}/Text-Levenshtein-Damerau-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Text-Levenshtein-Damerau/d04a7f689d4fb6e5fe0beba6c4b3959ad6c0dd2c || :
if test -f Makefile.PL; then
